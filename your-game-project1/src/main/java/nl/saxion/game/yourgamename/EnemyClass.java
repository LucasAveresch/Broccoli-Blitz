...
public class EnemyClass {
    ...
    public EnemyClass(String filepath, String textureKey, String filepath2, String textureKey2,
    ...
    // ⭐ NIEUW: enemy beweegt mee met gameSpeed
    public void update(float delta) {
        enemyXPos -= enemyspeed * YourGameScreen.gameSpeed * delta;
    }

    // ⭐ Tekenen
    public void draw() {
        GameApp.drawTexture(textureKey, enemyXPos, enemyYPos, 150, 150);
    }
}